...
enum {
	...
	CSS_ASYNC	= (1 << 5), /* css is async */
	CSS_SCUT    = (1 << 7), /* css is a shortcut for core*/
};
...
struct cgroup {
	...
	struct cgroup_subsys_state self;
	struct list_head tasks; // shortcut for container
...
struct cftype {
	...
	unsigned int cgroup_shim_file_offset;
...
struct cgroup_subsys {
	...
	void (*async_alloc_finish)(struct cgroup_subsys_state *css);
...
struct sock_cgroup_data {
	...
	struct cgroup_shim	*cgroup_shim; /* v2 */
